...
import { X, Eye, EyeOff, Building, Mail, AlertCircle, CheckCircle, User, Phone, MapPin, Hash, Users, Shield } from 'lucide-react';
...
const ValidationSchema = Yup.object({
    name: Yup.string()
        ...
        .max(100, 'Theater name cannot exceed 100 characters'),
    ...
    screens: Yup.number()
        ...
        .max(50, 'Maximum 50 screens'),
    capacity: Yup.number()
        .min(0, 'Capacity cannot be negative')
        .max(10000, 'Maximum capacity 10000'),
    password: Yup.string()
                    ...
                    <div className="p-6">
                        ...
                        <div className="mb-6 flex items-start gap-2 p-3 bg-blue-50 rounded-lg border border-blue-200">
                            ...
                            <p className="text-xs text-blue-700">
                                ...
                                Theater owner will receive login credentials via email after creation.
                            </p>
                        </div>
                                        ...
                                        <div className="flex items-start gap-2">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-emerald-700 mt-0.5">
                                                    Theater credentials will be encrypted and stored securely. An email will be sent to the theater owner with their login information.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
